<template>
  <div class="activity-content-card bg-white rounded-xl shadow-card p-8 max-w-3xl mx-auto">
    ...
    <!-- 活动标题 -->
    <h2 class="activity-title font-bold text-3xl text-black mb-4" style="letter-spacing:1px;">{{ activity.title }}</h2>
    <!-- 活动内容 -->
    <div class="activity-desc text-lg text-black mb-6" style="white-space: pre-wrap;">
      {{ activity.content }}
    </div>
    <!-- 活动地点 -->
    <div class="flex items-center text-base text-gray-700 mb-4">
